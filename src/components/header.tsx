        ...
        () => [
            {
                name: 'Overview',
                href: '/products',
                desc: 'Discover how our full suite of products work together',
                Icon: LayoutGrid,
                ...
                <nav className="hidden items-center gap-1 md:flex">
                    ...
                    <DropdownMenu open={prodOpen} onOpenChange={setProdOpen}>
                        ...
                        <DropdownMenuContent align="start" className="w-[760px] p-3">
                            ...
                            <div className="mt-2 mb-3 grid grid-cols-2 gap-3">
                                {products.map((p) => (
...
/** Карточка продукта (desktop megamenu) */
function ProductCard({ name, href, desc, Icon, gradient }: ProductItem) {
    return (
        ...
        >
            <span
                className={cn(
                    'grid place-items-center h-14 w-14 rounded-xl text-white shadow-md shrink-0',
                    'bg-gradient-to-br',
                    gradient
                )}
            >
