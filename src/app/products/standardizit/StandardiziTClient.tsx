...
export default function StandardiziTClient() {
    const features = [
        ...
        },
        {
            title: 'Approval',
            desc:
                'Two-party approvals (creator/approver).',
            Icon: ShieldCheck,
        },
    ] as const;
    ...
    const steps = [
        {
            ...
            desc:
                'Choose product, department, team and area — a short ID is generated automatically.',
        },
        {
            title: 'Add options & structure',
            desc:
                'Options for variants. Steps and WES substeps; renaming a step keeps links and numbering consistent.',
        },
        {
            title: 'Attach content',
            desc:
                'Images/videos, documents, layout diagrams, parts, PPE and equipment.',
        },
        {
            title: 'Define Key Points',
            desc:
                'Codes/types, reasons and notes for steps and WES — all in one place.',
        },

        {
            title: 'Sign & publish',
            desc:
                'Creator and approver confirm. Any change recomputes the snapshot hash and clears signatures.',
        },
    ] as const;
                    ...
                    <div className="grid gap-10 md:grid-cols-2 md:items-center">
                        ...
                        <div>
                            <span className="inline-flex items-center gap-2 rounded-full bg-sky-50 px-3 py-1 text-sky-700 ring-1 ring-sky-100">
                                <span className="inline-grid place-items-center size-5 rounded-md bg-sky-600 text-white">
                        ...
                        >
                            <Image
                                src="/standardizit_hero.svg" // replace with your artwork if needed
