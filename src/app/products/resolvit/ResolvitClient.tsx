...
export default function ResolvITClient() {
    ...
    const features: FeatureItem[] = [
        ...
        },
        {
            title: 'Raise Problem',
            desc:
                'Spin off an issue into a Problem case with its own ID, assignee, SLA, and follow-up tracking.',
            Icon: AlertTriangle,
            gradient: 'from-violet-600 to-purple-600',
        },
        {
    ...
    const heroBullets: HeroBullet[] = [
        ...
        {
            text: 'Raise Problem from GoSeeiT / StandardiziT / Yamazumi',
            Icon: AlertTriangle,
                    ...
                    >
                        {steps.map((s, i) => (
                            <motion.li
                                key={s.title}
                                variants={fadeUp}
                                className="rounded-2xl border bg-white p-4 shadow-sm h-full min-h-[150px] flex"
                            >
